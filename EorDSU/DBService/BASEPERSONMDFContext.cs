...
{
    public class BASEPERSONMDFContext : DbContext
    {
        ...
        public DbSet<PersDepartment> PersDepartments { get; set; } = null!;
        public DbSet<PersDivision> PersDivisions { get; set; } = null!;
